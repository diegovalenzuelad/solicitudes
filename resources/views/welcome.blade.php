...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <section class="flex flex-col items-center space-y-4 py-12">
            ...
            <form class="p-4 w-1/5">
                <div class="mb-4">
                    <input class="p-2 bg-gray-200 w-full" type="text" name="text" placeholder="Tarea...">
                </div>
                <button type="submit" class=" btn btn-outline-dark font-bold w-full rounded shadow p-2">Guardar</button>
            </form>

            <table class="table table-hover shadow-md w-1/3">
                <thead>
